...
namespace Lottery.Business
{
    ...
    {
        public Model_Cycle_KillTwoNum_Middle(List<DB_PredictRecord> history, int ct = 455, int rg = 1440) : base(history)
        {
            Critical = ct;
            Range = rg;
        }

        public Model_Cycle_KillTwoNum_Middle(List<DB_PredictRecord> history, string killno1, string killno2,int ct = 455, int rg = 1440) : base(history)
        {
